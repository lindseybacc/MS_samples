/*
 ...
 @note This is the abstract class UserAccounts.java
       This file creates, saves, and performs actions onto user accounts.
...
abstract class UserAccounts {
    Scanner input = new Scanner(System.in);
    Random randGenerator = new Random();         // to create account numbers
    private double checkAccNum;                  // to set customer checking account number
    private double savingAccNum;                 // to set customer savings account number
    private double calculate;                    // to calculate and store new balances into table
    private Hashtable<String,Double> userInfo = new Hashtable<>(); // storing user info into a hash table
